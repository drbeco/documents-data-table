...
class Frontend_Scripts implements Registerable, Service {
    ...
    public function register_styles() {
        ...
        \wp_enqueue_style( 'documents-data-table', \plugins_url( "assets/css/documents-data-table{$suffix}.css", $this->plugin->get_file() ), array( 'jquery-data-tables' ), $this->plugin->get_version() );
    }
    ...
    public function register_scripts() {
        ...
        \wp_enqueue_script( 'documents-data-table', \plugins_url( "assets/js/documents-data-table{$suffix}.js", $this->plugin->get_file() ), array( 'jquery-data-tables' ), $this->plugin->get_version(), true );
        ...
        if ( \array_key_exists( $locale, $supported_locales ) ) {
            \wp_localize_script( 'documents-data-table', 'posts_data_table', array(
